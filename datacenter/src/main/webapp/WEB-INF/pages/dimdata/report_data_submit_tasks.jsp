...
<script type="text/javascript">
  	...
  	/* 	function GetPercent(num, total) { 
  		...
  		$.post("<%=request.getContextPath()%>/report/report_data_submit_tasks/query.html",
			{'page':page,
...
// 		    			+ '<td>' + GetPercent(n.s3,n.s3+n.s4) + '</td>'
	...
	function queryDataSubmitTasks() {
		...
		$.ajax({
			url: "<%=request.getContextPath()%>/report/report_data_submit_tasks/query.html?page=1&qTimeRange="+qTimeRange+"&qStartDate="+qStartDate+"&qEndDate="+qEndDate+"&systemtype="+systemtype,
			dataType: "json",
										...
										<table class="table">
											...
											<tr>
												<td colspan="8" style="text-align: right">
													<button type="button" class="btn btn-primary" onclick="javascript:queryDataSubmitTasks();">查询</button>
												</td>
											</tr>
										</table>
									</div>
