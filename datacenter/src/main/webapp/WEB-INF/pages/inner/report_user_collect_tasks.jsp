...
<script type="text/javascript">
	function GetPercent(num, total) { 
  	...
  	function list(page) {
		...
		if(qTimeRange==4){
  		...
  		$.post("<%=request.getContextPath()%>/report/report_user_collect_tasks/query.html",
			{'page':page,
	...
	function queryUserCollectTasks() {
		...
		$.ajax({
			url: "<%=request.getContextPath()%>/report/report_user_collect_tasks/query.html?page=1&username="+username+"&qTimeRange="+qTimeRange+"&qStartDate="+qStartDate+"&qEndDate="+qEndDate+"&systemtype="+systemtype,
			dataType: "json",
	...
	function exprotExcel() {
		qDate = $("#dtp_input2").val();
  		...
  		window.open('<%=request.getContextPath()%>/report/report_user_collect_tasks/exprotExcel.html?qDate='+qDate+'&status='+status);
	}
</script>
