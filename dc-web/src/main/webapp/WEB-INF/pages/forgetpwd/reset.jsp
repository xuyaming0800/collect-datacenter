	...
	<div class="alertbox height2">
	    ...
	    <dl class="alertbox-dl">
	        ...
	        <dd style="margin-bottom:10px; margin-top:30px; text-align:center;"> 
	        	<a href="<%=request.getContextPath() %>/index/login.html" class="mailbtn">立即登录</a>
	        </dd>
	    </dl>
...
<div class="rainbow_login rainbow_loginwidth padtop" >
 ...
 <p class="clearfix"><span class="sheet01 sheet_wrong"><label>新密码</label><input id="newpass" type="password" /></span>
