...
<div class="rainbow_login rainbow_loginwidth padtop" >
  ...
  <p class="clearfix"><span class="sheet01 sheet_wrong"><label>账&nbsp;&nbsp;号</label><input id="input_account" type="text" /></span></p>
  <p class="clearfix"><span class="sheet01 sheet02  "><label>验证码</label><input id="input_code" type="text" maxlength="4" /></span>
  <span class="checkcode" id="checkCode"></span><label><a href="##" class="re0" onclick="createCode()">看不清？换一张</a></label></p>
  <p></p>
   <p></p>
